                ...
                <div class="col-md-3 col-sm-3">
                  ...
                  <div class="col-md-8 col-sm-8">
                    <div class="profile_wrap">
                      <h5 class="uppercase underline">Reservasi Saya</h5>
                      <div class="my_vehicles_list">
                        <ul class="vehicle_listing">
                          ...
                          ?>
                              ...
                              <li>
                                <h4 style="color:red">No. Reservasi &nbsp;<?php echo htmlentities($result->BookingNumber); ?></h4>
                              ...
                              <table>
                                ...
                                <tr>
                                  ...
                                  <td>Rp. <?php echo htmlentities(number_format($ppd = $result->PricePerDay, 0, ',', '.')); ?></td>
                                </tr>
                                <tr>
                                  <th colspan="4" style="text-align:center;"> Grand Total</th>
                                  <th>Rp. <?php echo htmlentities(number_format($tds * $ppd, 0, ',', '.')); ?></th>
                                </tr>
                              </table>
                              <hr />
                            <?php
