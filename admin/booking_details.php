            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="modal-header">
                  <h5 class="modal-title" style="float: left;">Detail Reservasi</h5>
                </div>
                <div class="table-responsive p-3" id="print">
                  <table class="table align-items-center table-flush table-hover table-bordered" id="">
                    ...
                    from tblbooking join tblvehicles on tblvehicles.id=tblbooking.VehicleId join tblusers on tblusers.EmailId=tblbooking.userEmail join tblbrands on tblvehicles.VehiclesBrand=tblbrands.id where tblbooking.id=:bid";
                      ...
                      ?>
                          <h3 style="text-align:center; color:red">#<?php echo htmlentities($result->BookingNumber); ?> Detail Reservasi </h3>

                          <tr>
                            <th colspan="4" style="text-align:center;color:blue">Detail Penyewa</th>
                          </tr>
                          <tr>
                            <th>No. Reservasi</th>
                          ...
                          <tr>
                            <th colspan="4" style="text-align:center;color:blue">Detail Reservasi</th>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td>Rp. <?php echo htmlentities(number_format($ppdays = $result->PricePerDay, 0, ',', '.')); ?></td>
                          </tr>
                          <tr>
                            <th colspan="3" style="text-align:center">Grand Total</th>
                            <td>Rp. <?php echo htmlentities(number_format($tdays * $ppdays, 0, ',', '.')); ?></td>
                          </tr>
                          <tr>
                          ...
                          ?>
                            <tr>
                              <td style="text-align:center" colspan="4">
                                <a href="booking_details.php?aeid=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Do you really want to Confirm this booking')" class="btn btn-primary"> Konfirmasi Reservasi</a>

                                <a href="booking_details.php?eid=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Do you really want to Cancel this Booking')" class="btn btn-danger"> Tolak Reservasi</a>
                              </td>
                            </tr>
                          <?php
                          } ?>
