...
<body id="body">
  ...
  <section id="innerBanner">
    <div class="inner-content">
      <h2><span>Daftar Mobil</span><br>Kami Menyiapkan Mobil Kualitas Terbaik</h2>
      <div>
      </div>
    </div>
  </section><!-- #Page Banner -->
            ...
            <div class="col-md-9 col-md-push-3">
              ...
              ?>
                  <div class="product-listing-m gray-bg">
                    <div class="product-listing-img"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1); ?>" class="img-responsive" alt="Image" style="height: 207px;  width:300px;" /> </a>
                    </div>
                    <div class="product-listing-content">
                      ...
                      <p class="list-price">Rp.<?php echo htmlentities(number_format($result->PricePerDay, 0, ',', '.')); ?> Per Day</p>
                      <ul>
            ...
            <aside class="col-md-3 col-md-pull-9">
              <div class="sidebar_widget">
                <div class="widget_heading">
                  <h5><i class="fa fa-car" aria-hidden="true"></i> Paling Sering Dilihat</h5>
                </div>
                    ...
                    ?>
                        ...
                        <li class="gray-bg">
                          ...
                          <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->BrandName); ?> <?php echo htmlentities($result->VehiclesTitle); ?></a>
                            <p class="widget_price">Rp.<?php echo htmlentities(number_format($result->PricePerDay, 0, ',', '.')); ?> Per Day</p>
                          </div>
                        </li>
                    <?php
                      }
