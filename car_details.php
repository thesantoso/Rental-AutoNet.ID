  ...
  <main id="main">
    ...
    <section class="listing-detail">
      <div class="container">
        <div class="listing_detail_head row">
          ...
          <div class="col-md-3">
            <div class="price_info">
              <p>Rp.<?php echo htmlentities(number_format($result->PricePerDay, 0, ',', '.')); ?> </p>/ Day
            ...
            <div class="listing_more_info">
              <div class="listing_detail_wrap">
                ...
                <ul class="nav nav-tabs gray-bg" role="tablist">
                  <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" style="background-color: #49a3ff;" data-toggle="tab">Ringkasan Kendaraan </a></li>
        ...
        <!--Similar-Cars-->
        <div class="similar_cars" align="center">
          <h3>MOBIL TERKAIT</h3>
          <div class="row">
            <?php
            $bid = $_SESSION['brndid'];
