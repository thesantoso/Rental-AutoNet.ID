...
<body id="body">
  ...
  <section id="innerBanner">
    <div class="inner-content">
      <h2><span>Kontak & Bantuan</span><br>Kami Melayani Anda Dengan Baik</h2>
      <div>
      </div>
    </div>
  </section><!-- #Page Banner -->
    ...
    <section id="contact" class="wow fadeInUp">
      <div class="container">
        <div class="section-header">
          <p>Rentau AutoNet.ID adalah biro perjalanan dan wisata domestik serta agen transportasi wisatawan yang berdiri sejak 2011. Cita-cita terbesar kami adalah bisa melayani sebanyak mungkin orang berlibur dengan fasilitas terlengkap, service terbaik, dan harga terjangkau.</p>
        </div>
        ...
        <div class="row contact-info">
          <div class="col-lg-5">
            <div class="contact-address">
              ...
              <h3>Alamat</h3>
              <address>Kuningan, Jakarta Selatan 11504</address>
            </div>
            <div class="contact-phone">
              <i class="ion-ios-telephone-outline"></i>
              <h3>Telepon</h3>
              <p><a href="tel:+155895548855">+62 8778-1404-2002</a></p>
            </div>
            <div class="contact-email">
              <i class="ion-ios-email-outline"></i>
              <h3>Email</h3>
              <p><a href="mailto:info@example.com">Rentalnet@gmail.com</a></p>
            </div>
          </div>
          <div class="col-lg-7">
            <div class="container">
